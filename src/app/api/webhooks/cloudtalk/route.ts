 ...
 *
 * Business number matched by `data.to` against clients.provider_phone_number (E.164).
 */
...
import { cloudtalk } from '@/lib/providers/cloudtalk'
...
export async function POST(req: Request) {
  ...
  try {
    ...
    await db.from('errors').insert({
      context: `cloudtalk_webhook_${event}`,
