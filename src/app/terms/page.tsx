  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 bg-white/90 backdrop-blur-md border-b border-gray-100">
      ...
      <div className="flex items-center gap-4">
        <Link href="/privacy" className="text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors">Privacy Policy</Link>
        <Link
          href="/onboarding"
      ...
      <div className="min-h-screen bg-gray-50 pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-center text-xs text-gray-400 mt-8">
            © {new Date().getFullYear()} Velza LLC · <Link href="/privacy" className="underline">Privacy Policy</Link>
          </p>
        </div>
      </div>
    </>
